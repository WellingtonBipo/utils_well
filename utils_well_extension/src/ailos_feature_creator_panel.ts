...
export function activate(context: vscode.ExtensionContext) {
    context.subscriptions.push(
        vscode.commands.registerCommand("ailosDevTools.featureCreator", () => {
            AilosFeatureCreatorPanel.render(context);
        })
    );
}

class AilosFeatureCreatorPanel {
    public static currentPanel: AilosFeatureCreatorPanel | undefined;
    ...
    public static render(context: vscode.ExtensionContext) {
        if (AilosFeatureCreatorPanel.currentPanel) {
            AilosFeatureCreatorPanel.currentPanel._panel.reveal(vscode.ViewColumn.One);
        } else {
            ...
            panel.iconPath = vscode.Uri.joinPath(context.extensionUri, "media", "logo-ailos.svg");
            AilosFeatureCreatorPanel.currentPanel = new AilosFeatureCreatorPanel(context, panel);
        }
    }

    public dispose() {
        AilosFeatureCreatorPanel.currentPanel = undefined;
        this._panel.dispose();
